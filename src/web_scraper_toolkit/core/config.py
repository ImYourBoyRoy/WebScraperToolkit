...
class ScraperSettings:
    ...
    default_viewport: Dict[str, int] = field(default_factory=lambda: {"width": 1400, "height": 1000})
...
class ScraperConfig:
    ...
    def load(cls, overrides: Dict[str, Any] = None) -> 'ScraperConfig':
        ...
        scraper_settings = ScraperSettings(
            ...
            default_viewport=scraper_settings_data.get("default_viewport", {"width": 1400, "height": 1000}),
            default_timeout_seconds=scraper_settings_data.get("default_timeout_seconds", 60),
