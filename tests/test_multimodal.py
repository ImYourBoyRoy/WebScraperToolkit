...
from web_scraper_toolkit.parsers.scraping_tools import extract_metadata, capture_screenshot, save_as_pdf
...
class TestMultimodal(unittest.TestCase):
    ...
    def test_extract_metadata(self):
        ...
        with patch('web_scraper_toolkit.browser.playwright_handler.PlaywrightManager') as MockManager:
            instance = MockManager.return_value
            instance.start = AsyncMock()
            instance.stop = AsyncMock()
            # return content, url, status
            instance.smart_fetch = AsyncMock(return_value=(html_content, "https://example.com", 200))
